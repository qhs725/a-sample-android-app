...
public class BluetoothService {
    ...
    private class AcceptThread extends Thread {
        ...
        public void cancel() {
            ...
            try {
                ...
                Log.e(TAG, "Socket type --> " + mSocketType + "close server failed", e);
            }
        }
    }
    ...
    */
    private class ConnectThread extends Thread {
        ...
        public void cancel() {
            try {
                ...
                Log.e(TAG, "close connect " + mSocketType + " socket failed", e);
            }
        }
    }
    ...
    /**
     * Thread to run during remote connection
     * handles all in/out transmissions
     */
